...
module.exports = {
  ...
  botname: process.env.BOT_NAME || '🇹Є𝚫⃟〽️💯🇩ƦƛƓƠƝ',
  ...
  alivemsj: process.env.ALIVE_MSJ || '*POWERD BY 🇹Є𝚫⃟〽️💯🇩ƦƛƓƠƝ* 🎊',
  ownername:process.env.OWNER_NAME || '➤⃟🌟⃢🇦𝕝𝕚 🌟⃢🇲𝕚𝕣𝕫𝕒➤⃟',
  sessionName: process.env.SESSION_ID || '5ykQWZaQ#LMKw0M8eYIIqmZFEsXmCzDKwlURjyaXv4yhBZLLbIaU',
